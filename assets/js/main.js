const IW_CONFIG = {
  businessName: 'iKHETHELO WORX',
  // Placeholder contact details. Replace these with final business contact information.
  email: 'queries@ikhetheloworx.co.za',
  phone: '+27 84 351 7720',
  whatsAppNumber: '27843517720',
  address: 'Durban, South Africa',
  linkedInUrl: 'https://www.linkedin.com/company/ikhethelo-worx',
};

window.IW_CONFIG = IW_CONFIG;

const buildWhatsAppUrl = (message = 'Hello iKHETHELO WORX, I would like to discuss a project.') =>
